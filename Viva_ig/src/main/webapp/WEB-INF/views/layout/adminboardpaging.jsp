		...
		<c:when test="${page.startPage ne 1}">
		    <c:choose>
				<c:when test="${empty keyword}">
					<li class="page-item"><a href="./boardlist?curPage=${paging.startPage - paging.pageCount}&amp;categoryType=${categoryType}" class="page-link">&laquo;</a></li>
				</c:when>
				<c:otherwise>
					<li class="page-item"><a href="./boardlist?curPage=${paging.startPage - paging.pageCount}&amp;categoryType=${categoryType}&amp;keyword=${keyword}" class="page-link">&laquo;</a></li>
				</c:otherwise>
			</c:choose>
		</c:when>
